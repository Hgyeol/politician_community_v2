import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, hasInjectionContext, inject, ref, h, Suspense, toRef, isRef, getCurrentInstance, provide, shallowReactive, Fragment, createApp, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, shallowRef, isReadonly, isShallow, isReactive, toRaw, defineAsyncComponent, mergeProps, getCurrentScope, useSSRContext } from 'vue';
import { i as hasProtocol, k as isScriptProtocol, l as joinURL, w as withQuery, s as sanitizeStatusCode, m as getContext, $ as $fetch, n as createHooks, o as executeAsync, p as getHeader, c as createError$1, t as toRouteMatcher, q as createRouter$1, r as defu, v as setCookie } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./index-ClPjbUo3.mjs')
  },
  {
    name: "profile",
    path: "/profile",
    meta: { ...__nuxt_page_meta$4 || {}, ...{ "middleware": "auth" } },
    component: () => import('./profile-GvBrgzP_.mjs')
  },
  {
    name: "auth-login",
    path: "/auth/login",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./login-DHgE-VOJ.mjs')
  },
  {
    name: "auth-signup",
    path: "/auth/signup",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./signup-CYFIwKVr.mjs')
  },
  {
    name: "politicians",
    path: "/politicians",
    component: () => import('./politicians-BnTD3dCa.mjs'),
    children: [
      {
        name: "politicians-id-suggestions",
        path: ":id()/suggestions",
        component: () => import('./suggestions-C2Nebpjq.mjs')
      }
    ]
  },
  {
    ...
    component: () => import('./new-CbL8fww0.mjs')
  },
  {
    name: "suggestions-id",
    path: "/suggestions/:id()",
    meta: __nuxt_page_meta || {},
    component: () => import('./_id_-CqRHJvZZ.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Cyd0Sykm.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BdIaVw0u.mjs'));
...
export { LayoutMetaSymbol as L, PageRouteSymbol as P, _export_sfc as _, useNuxtApp as a, useRoute as b, appLayoutTransition as c, _wrapInTransition as d, entry_default as default, __nuxt_component_1 as e, useSupabaseUser as f, defineNuxtRouteMiddleware as g, useRuntimeConfig as h, nuxtLinkDefaults as i, navigateTo as n, resolveRouteObject as r, useRouter as u };
