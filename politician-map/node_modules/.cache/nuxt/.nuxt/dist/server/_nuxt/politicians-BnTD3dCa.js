import { defineAsyncComponent, defineComponent, inject, computed, unref, shallowRef, h, Suspense, nextTick, mergeProps, provide, shallowReactive, withCtx, createVNode, useSSRContext } from "vue";
import { a as useNuxtApp, P as PageRouteSymbol, b as useRoute, c as appLayoutTransition, d as _wrapInTransition, L as LayoutMetaSymbol, e as __nuxt_component_1 } from "../server.mjs";
...
import "@supabase/ssr";
const layouts = {
  default: defineAsyncComponent(() => import("./default-CJrwvjoE.js").then((m) => m.default || m))
};
...
//# sourceMappingURL=politicians-BnTD3dCa.js.map
